...
export const SWITCH_TERM_ITEMS = [
  "One 30-day Clover Plus reward per eligible verified Free user, subject to receipt review.",
  "Paid budgeting or personal-finance app purchases qualify; free trials and refunded purchases do not.",
  "Existing paid subscribers are excluded.",
  "Activate within seven days of approval.",
  "No payment details or automatic renewal are required.",
  "Existing records remain accessible after expiry; bank connections require eligible paid access.",
  "Unused promotional days have no cash value.",
  "Evidence is private, reviewed for this offer, and deleted after 90 days; application and reward records remain for eligibility and audit."
] as const;
export const SWITCH_TERMS = SWITCH_TERM_ITEMS.join(" ");
