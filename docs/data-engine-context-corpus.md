...
- Worldwide reviewed packs: 197 regional parsing profiles and 198 canonical country/global contexts across Latin America, the Caribbean, Europe, the Middle East and North Africa, Sub-Saharan Africa, Central Asia, South Asia, East Asia, Southeast Asia, North America, and Oceania
...
The third worldwide canonical pass adds another 30 regional profiles: Venezuela, Barbados, The Bahamas, Belize, Guyana, Suriname, Haiti, Angola, Namibia, Zimbabwe, Cameroon, Gabon, the Democratic Republic of the Congo, Madagascar, Seychelles, Cabo Verde, Benin, Togo, Sierra Leone, Lebanon, Iraq, Maldives, Bhutan, Papua New Guinea, Samoa, Tonga, Vanuatu, Solomon Islands, Montenegro, and Tajikistan. Each market has five independently useful contexts covering banks or payment infrastructure plus household transport, grocery, telecom, or utility activity.

This phase also adds 60 purpose-depth entries to 20 existing country packs. The added signals cover healthcare, telecom, groceries, dining, transport, and utilities in Albania, Argentina, Bosnia and Herzegovina, Bangladesh, Bahrain, Brunei, Brazil, Botswana, Czechia, Ethiopia, Georgia, Ghana, Israel, Jordan, Morocco, Myanmar, Nigeria, Nepal, New Zealand, and Pakistan. The purpose-depth layer is separate from payment-rail evidence and does not label transactions as expenses automatically.

Regression coverage now includes every phase-three market, representative depth entries, localized Arabic and Cyrillic forms, and cross-market collision controls. In particular, Togo TMoney and Korea T-money are disambiguated with explicit negative evidence so both remain usable without a shared short alias producing a false country match.

The fourth worldwide canonical pass adds 30 more regional profiles: Andorra, Liechtenstein, Monaco, San Marino, Kosovo, Belarus, Iran, Palestine, Yemen, Libya, Mali, Burkina Faso, Niger, Guinea, Liberia, The Gambia, Mauritania, Sudan, Djibouti, Somalia, Lesotho, Eswatini, the Republic of the Congo, the Central African Republic, Equatorial Guinea, Sao Tome and Principe, Comoros, Turkmenistan, Afghanistan, and Palau. Each market receives two financial-institution or payment-infrastructure contexts plus transport, grocery, and utility evidence. Forty additional healthcare and telecom entries deepen 20 existing markets.
...
The recurring-commerce depth pass adds another 180 canonical providers across the same 60-market footprint. Each market receives independently scored insurance, ecommerce, and dining or food-delivery context. Marketplace and delivery coverage is deliberately separated from generic retail context so recurring orders can be recognized without assuming that every transaction from the provider is a subscription or expense.

Commerce entries are availability-sensitive. Known exited services are excluded, uncertain delivery markets use stable local retailers or restaurant chains instead, and every cross-border brand remains country-qualified. Thirty representative fixtures cover insurance, ecommerce, dining, delivery, localized Asian aliases, and all four regions. Additional controls ensure generic uses such as `Quick Note`, `Happy Song`, `Universal Remote`, and `Jubilee Party` do not inherit a country or purpose from the new entries.

The phase follows [UNCTAD's current ecommerce and digital-trade implementation work](https://unctad.org/publication/fast-tracking-implementation-reforms-enabling-e-commerce-and-digital-trade), which emphasizes that national ecosystems vary materially across Africa, Asia, the Pacific, and Latin America. European insurer curation is cross-checked against the [European Commission directory of insurance authorities](https://finance.ec.europa.eu/regulation-and-supervision/european-system-financial-supervision/insurance-and-pensions-authorities-and-organisations_en); Clover stores provider-name evidence only, not licensing, market-share, or regulatory claims.
...
Worldwide rail validation references: [BCRA Transferencias 3.0](https://www.bcra.gob.ar/transferencias-3-0/), [BCRP retail-payment interoperability](https://www.bcrp.gob.pe/docs/Sistema-Pagos/articulos/estrategia-de-interoperabilidad-2025-1.pdf), [SIBS MB WAY](https://www.docs.pay.sibs.com/portugal/sibs-gateway/faqs-sibs-gateway/), [Magyar Nemzeti Bank qvik](https://www.mnb.hu/penzforgalom/qvik), [TRANSFOND RoPay](https://www.transfond.ro/pdf/RA%202024%20Transfond%20EN%20fin.pdf), [Central Bank of Jordan CliQ](https://cbj.gov.jo/EN/List/Payment_Systems_Legislations), [Egypt InstaPay](https://www.instapay.eg/?lang=en&page_id=348), [Bahrain BENEFITPay](https://benefit.bh/Personal/benefitpay/), [National Bank of Ethiopia licensed payment issuers](https://nbe.gov.et/payment-instrument-issuers-system-operators/), [BCEAO electronic-money issuers](https://www.bceao.int/en/content/electronic-money-issuing-institutions-0), [National Bank of Rwanda payment systems](https://www.bnr.rw/paymentsystems), [Nepal connectIPS](https://connectips.com/index.php/faq), [Eesti Pank RT1](https://www.eestipank.ee/en/payments/rt1-instant-payment-system), [Latvijas Banka instant payments](https://www.bank.lv/en/operational-areas/payment-systems/instant-payments), [Bank of Lithuania instant payments](https://www.lb.lt/en/instant-payments), [Národná banka Slovenska instant payments](https://nbs.sk/en/instant-payments/), [National Bank of Serbia IPS](https://ips.nbs.rs/en), [Banco Central del Paraguay SPI](https://www.bcp.gov.py/sistemas-de-pago-y-tesoreria), [Banco Central de Reserva de El Salvador Pay/Transfer365](https://365pay.bcr.gob.sv/ayuda/), [Bank of Jamaica JAM-DEX](https://boj.org.jm/core-functions/currency/cbdc/), [National Bank of Kazakhstan instant payments](https://nationalbank.kz/en/news/novosti/13765), [Central Bank of The Bahamas digital payments](https://www.centralbankbahamas.com/digital-payments), [Maldives Monetary Authority Favara](https://www.mma.gov.mv/documents/iulaan/PR-2023-5181-english.pdf), [BEAC CEMAC payment systems](https://www.beac.int/systemes-paiement/presentation-generale/), [Royal Monetary Authority Bhutan QR](https://www.rma.org.bt/dpSystem/), [Central Bank of Belize payment and settlement](https://www.centralbank.org.bz/home/core-functions/payment-and-settlement), [BSP Papua New Guinea digital payments](https://www.bsp.com.pg/personal-banking/ways-to-bank/bsp-pay/), [BCEAO PI-SPI](https://pispi.bceao.int/accueil?field_categorie_target_id=4), [Central Bank of Somalia National Payment System](https://centralbank.gov.so/nps/), and [Da Afghanistan Bank Afghanistan Payments System](https://dab.gov.af/afghanistan-payments-system-directorate-general).

The fifth balanced-country pass adds Antigua and Barbuda, Burundi, Chad, Cuba, Dominica, Eritrea, Grenada, Guinea-Bissau, the Marshall Islands, Micronesia, Saint Kitts and Nevis, Saint Lucia, Saint Vincent and the Grenadines, South Sudan, Syria, Timor-Leste, Tuvalu, and Russia. Each receives two financial institutions plus transport, grocery, and utility evidence and a locale-aware regional parsing profile. The pass intentionally omits markets for which maintainable, current consumer-finance evidence could not be established rather than presenting speculative aliases as worldwide coverage.

The traveler-depth layer adds 120 country-qualified pharmacy or health-retail and airline, ferry, or hotel contexts across 60 existing markets. Travel providers set `travelLikely` and `purposeHint: travel`; health retailers set `purposeHint: healthcare`. Neither layer supplies a transaction type. A provider can therefore enrich an unfamiliar row without silently deciding whether the row is an expense, transfer, or another user-confirmed type.

Phase-five regression coverage exercises all 18 new parsing profiles and one travel or healthcare signal in every deepened market. Geography-qualified traveler evidence is stronger than broad airline vocabulary, but a bare shared brand remains insufficient country evidence. Quality gates require 1,838 canonical entries, 4,906 unique aliases, 198 country/global contexts, 197 profiles, 144 currencies, and zero duplicate aliases, IDs, or profiles.

Phase-five institution and traveler validation uses official registries where available. Examples include the [Banco Central de Timor-Leste financial-institution register](https://www.bancocentral.tl/en/go/financial-institution), the [Bank of Russia national payment-system register](https://www.cbr.ru/eng/Psystem/), [ICAO designator and indicator tools](https://www.icao.int/operational-safety/Designators-and-indicators), and the [WHO Geolocated Health Facilities Data initiative](https://www.who.int/data/GIS/GHFD). Clover retains only narrow provider-name and geographic evidence; it does not copy licensing status, schedules, safety claims, or health-service claims into transaction records.

The essential-services depth pass adds 228 reviewed canonical entries across 76 markets that previously had only a thin country pack. Each market receives country-qualified telecom, healthcare, and education evidence, covering recurring connectivity bills, hospital and clinic payments, and tuition or campus payments. Every new entry is exercised through the production resolver, remains neutral about transaction type, and cannot replace a confirmed merchant, category, amount, or type.

The pass follows maintainable global naming sources rather than treating crowdsourced merchant strings as authoritative. The [ITU ICT-Eye](https://www.itu.int/net4/ITU-D/icteye/About.aspx) supplies country-level ICT context; the [WHO Geolocated Health Facilities Data initiative](https://www.who.int/data/GIS/GHFD) defines official name, type, and location as the minimum facility identity; and the [UNESCO World Higher Education Database](https://www.unesco.org/sdg4education2030/en/knowledge-hub/world-higher-education-database) covers recognized higher-education institutions. Clover stores narrow statement-recognition aliases only and does not infer accreditation, service quality, network availability, or operational status.

Phase-six quality gates require 2,066 canonical entries, 5,362 unique aliases, 120,720 descriptor variants, 198 country/global contexts, 197 parsing profiles, 144 currencies, and zero duplicate aliases, IDs, or profiles. Collision controls confirm that generic phrases such as `Team Meeting`, `Post Letter`, `Flow Chart`, `A1 Paper`, `TIM Clock`, and `MTS File` cannot claim a country from the newly added providers.

The worldwide completeness pass closes every remaining telecom, healthcare, and education gap across the 196 real-country contexts represented by the corpus. Synthetic `GLOBAL` and `EU` aggregation contexts are excluded from this country-level completeness rule. The 95 targeted entries use country-qualified provider names, remain neutral about transaction direction, and are checked as a permanent coverage invariant rather than a one-time count.

The fiscal-context layer adds 120 tax-administration and statutory social-contribution counterparties across 60 markets. These entries identify government purpose and counterparty context only. They deliberately omit a category and `transactionTypeHint`, because the same agency descriptor may appear in a payment, refund, withholding, contribution, or adjustment. Government context must therefore never decide `expense`, `income`, or `transfer` without transaction-direction evidence.

Fiscal entity curation follows official cross-country references from the [OECD Tax Administration Series](https://www.oecd.org/en/data/datasets/tax-administration-series-database.html), its [participating tax administrations](https://www.oecd.org/en/publications/tax-administration-2025_cc015ce8-en/full-report/participating-tax-administrations_b731dd80.html), and the [International Social Security Association country profiles](https://www.issa.int/databases/country-profiles/about). Education completeness continues to follow the [UNESCO World Higher Education Database](https://www.unesco.org/sdg4education2030/en/knowledge-hub/world-higher-education-database). Clover retains narrow name-recognition evidence only; it does not copy legal status, entitlement, contribution rules, rates, or policy claims.

Phase-eight quality gates require 2,281 canonical entries, 5,790 unique aliases, 130,992 descriptor variants, 198 country/global contexts, 197 parsing profiles, 144 currencies, complete telecom/healthcare/education context in every represented real country, and zero duplicate aliases, IDs, or profiles. Regression fixtures exercise every new canonical alias through the production resolver, verify purpose and geography, and assert that no new entry infers transaction direction.

The everyday-completeness pass adds the remaining 61 transport, grocery, and utility contexts needed across the represented real-country set. Together with the prior essential-services layer, all 196 real-country contexts now have at least one reviewed canonical signal for transport, groceries, utilities, telecom, healthcare, and education. This is enforced as a regression invariant; generated descriptor variants cannot satisfy the requirement.

The second fiscal layer adds 120 tax and statutory social-protection counterparties across 60 additional markets in Asia-Pacific, Europe, the Americas, the Caribbean, Africa, and the Middle East. Combined fiscal coverage now reaches 120 represented countries. The remaining markets are intentionally left unfilled until durable official institution evidence is available rather than populated with generic or speculative labels.

Tax-administration validation for this layer uses the [SGATAR member administration network](https://sgatar.org/public/about/), the [Intra-European Organisation of Tax Administrations](https://www.iota-tax.org/about-us/about-iota), and the [Inter-American Center of Tax Administrations](https://www.ciat.org/quienes-somos/?lang=en). Statutory contribution identities continue to follow the [International Social Security Association country profiles](https://www.issa.int/databases/country-profiles/about). These sources establish institutional context; Clover does not import tax rules, rates, benefit eligibility, or legal conclusions.

Phase-nine quality gates require 2,462 canonical entries, 6,146 unique aliases, 139,584 descriptor variants, 198 country/global contexts, 197 parsing profiles, 144 currencies, six-purpose everyday completeness across every represented real country, and zero duplicate aliases, IDs, or profiles. Every new entry is resolved through the production matcher with geography, purpose, and transaction-direction assertions, while generic phrases such as `Revenue Forecast`, `Social Gathering`, `Metro Design`, and `Fresh Start` must remain geographically neutral.

The third fiscal layer adds 152 country-qualified tax and statutory social-protection entries for the final 76 represented markets. All 196 real-country contexts now contain at least one reviewed tax-administration signal and one statutory social-protection signal. Shared abbreviations such as `DGI`, `CNSS`, `IRD`, `NIS`, and `SSB` are never stored alone in this layer; each alias includes its country or full institution name to prevent cross-market collisions.

Pacific tax identities are validated against the [Pacific Islands Tax Administrators Association member directory](https://pitaa.org/pitaa-members/). African coverage follows the [African Tax Administration Forum](https://ataftax.org/who-we-are/) and the [CREDAF Francophone administration network](https://credaf.org/en/). Social-protection identities continue to follow the [International Social Security Association country profiles](https://www.issa.int/databases/country-profiles/about). The corpus stores narrow institution-recognition context, not tax rates, contribution obligations, eligibility rules, sanctions, or legal advice.

Phase-ten quality gates require 2,614 canonical entries, 6,450 unique aliases, 146,880 descriptor variants, 198 country/global contexts, 197 parsing profiles, 144 currencies, eight-purpose completeness across every represented real country, and zero duplicate aliases, IDs, or profiles. Eight-purpose completeness covers transport, groceries, utilities, telecom, healthcare, education, tax, and statutory social protection. Every fiscal entry must resolve through the production matcher and return a null `transactionTypeHint`.
