...
- The full release gate initially stopped at Expo dependency compatibility because new SDK 57 patch versions were required. Applied the recommended patch updates without changing SDK or React Native versions. TypeScript and dependency compatibility now pass; full release gate is rerunning after merging the latest staging billing/analytics changes.
