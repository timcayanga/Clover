...
- Normalize both incoming and outgoing PDAX wallet movement to `PDAX` and categorize it as `Financial`, while preserving the source debit/credit direction for account matching.
