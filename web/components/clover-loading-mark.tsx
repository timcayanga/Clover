const markPaths = {
  ...
  topRight:
    "M124 40C124 51.0457 112.8071 60 99 60C94.5563 60 90.3837 59.0716 86.7676 57.4453L84.0713 60.1426L75.4639 51.5352L88 39L85.1719 36.1719L72.63574 48.707L64 40.0713L66.6416 37.4287C64.960359 33.7678 64 29.524 64 25C64 11.1929 72.95431 0 84 0H124V40Z",
  bottomRight:
    "M124 84C124 95.0457 115.0457 104 104 104C104 115.0457 95.0457 124 84 124C72.9543 124 64 115.0457 64 104V64H104C115.0457 64 124 72.95431 124 84Z",
  bottomLeft:
    "M40 124C28.9543 124 20 115.0457 20 104C8.9543 104 0 95.0457 0 84C0 72.95431 8.9543 64 20 64H60V104C60 115.0457 51.0457 124 40 124Z",
} as const;
