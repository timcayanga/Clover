...
export function CloverLoadingMark({ className }: CloverLoadingMarkProps) {
  return (
    ...
    >
      ...
      <path className="clover-loading-screen__leaf clover-loading-screen__leaf--2" style={{ animationDelay: "1600ms" }} d={markPaths.topRight} fill="url(#clover-loading-screen-top-right)" />
      <path className="clover-loading-screen__leaf clover-loading-screen__leaf--3" style={{ animationDelay: "3200ms" }} d={markPaths.bottomRight} fill="url(#clover-loading-screen-bottom-right)" />
      <path className="clover-loading-screen__leaf clover-loading-screen__leaf--4" style={{ animationDelay: "4800ms" }} d={markPaths.bottomLeft} fill="url(#clover-loading-screen-bottom-left)" />
      <defs>
