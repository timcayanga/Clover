...
export function SplitBillActionButtons({
  ...
  return (
    <div className={`split-bill-page-actions ${className}`.trim()}>
      <button className="button button-primary button-small transactions-action-button split-bill-action-button split-bill-action-button--add" type="button" onClick={onAddBill}>
