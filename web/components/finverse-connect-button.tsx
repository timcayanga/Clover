...
export function FinverseConnectButton({
  ...
  const [banks, setBanks] = useState<{id:string;name:string;countries:string[];logoUrl:string;accountType?:string;accountTypes?:Record<string,string>;logoUrls?:Record<string,string>}[]>([]);
