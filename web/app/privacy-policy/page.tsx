...
export default function PrivacyPolicyPage() {
  return (
    <PublicInfoShell active="privacy">
      <div className={styles.legalShell}>
        ...
        <section className={styles.summary} aria-label="Privacy at a glance">
          <article>
          ...
          <article>
            ...
            <p>
              Your personal financial records are not shared with a Circle
          ...
          <article>
            ...
            <p>
              Clover does not sell personal information or use it for behavioral
              advertising.
            </p>
          </article>
        </section>
        ...
        <div className={styles.legalLayout}>
          ...
          <article className={styles.legalContent}>
            <section className={styles.legalSection} id="scope">
              ...
              <p>
                ...
                purposes described here. You can contact us about privacy at{" "}
                <a href="mailto:hello@clover.ph">hello@clover.ph</a>.
              </p>
            </section>

            <section className={styles.legalSection} id="information">
              <h2>2. Information we collect</h2>
              <h3>Account and profile information</h3>
              <p>
                This includes your name, email address, profile photo,
                authentication identifiers, account settings, onboarding
                answers, and the Profiles you create to organize different parts
                of your finances.
              </p>
              <h3>Financial records you provide</h3>
              <p>
                This includes bank statements, receipts, screenshots,
                spreadsheets, manual entries, account balances, transaction
                histories, investments, recurring activity, budgets, goals, and
                split-bill details.
              </p>
              <h3>Information Clover creates from your records</h3>
              <p>
                Clover may extract and organize transactions, merchants,
              ...
              <p>
                If you use Circles or Split Bills, we process Circle names,
                invitations, member roles, shared expenses, settlement status,
                shared budgets or goals, commitments, activity history, and the
                specific records or investment summaries you choose to share.
              </p>
              ...
              <p>
                We may collect pages viewed, features used, button interactions,
                browser and device details, approximate location derived from
                network information, IP address, session and security events,
                diagnostics, and error information. If you contact us, we also
                process your message and any attachment you include.
              </p>
            </section>

            <section className={styles.legalSection} id="sources">
              <h2>3. Where information comes from</h2>
              <ul>
                <li>
                  Directly from you when you create an account, upload records,
                  enter information, or contact us.
                </li>
                <li>
                  From the files and financial records you ask Clover to
                  process.
                </li>
                <li>
                  From other Circle members when they invite you or add
                ...
                <li>
                  Automatically when you use Clover, such as usage, session, and
                  diagnostic events.
                </li>
              </ul>
            </section>
            ...
            <section className={styles.legalSection} id="uses">
              ...
              <ul>
                <li>
                  Create, authenticate, and maintain your account and Profiles.
                </li>
                <li>
                ...
                <li>
                  ...
                  billing, or service messages.
                </li>
                <li>
                  Prevent abuse, investigate incidents, enforce our Terms, and
                  protect Clover and its users.
                </li>
                <li>
                  Understand feature performance, troubleshoot errors, and
                  improve the service.
                </li>
                <li>
                  Meet legal, accounting, regulatory, and dispute-resolution
                  obligations.
                </li>
              </ul>
              <p>
                Depending on the activity, we process information to provide the
                service you requested, with your consent, to comply with law, or
                for legitimate purposes such as security, support, fraud
                prevention, and product improvement. We apply the principles of
            ...
            <section className={styles.legalSection} id="automation">
              ...
              <p>
                Clover does not move money, approve credit, execute trades, or
                make decisions with legal or similarly significant effects on
                your behalf.
              </p>
            </section>
            ...
            <section className={styles.legalSection} id="sharing">
              ...
              <ul>
                ...
                <li>
                  <strong>At your direction.</strong> We share information with
                  Circle members, split-bill participants, or another recipient
                  when you use a sharing feature.
                </li>
                <li>
                  <strong>Legal and safety reasons.</strong> We may disclose
                  information when reasonably necessary to comply with law, a
                  valid legal request, enforce our Terms, investigate fraud or
                  abuse, or protect rights, safety, and security.
                </li>
                <li>
                  <strong>Business changes.</strong> Information may be
            ...
            <section className={styles.legalSection} id="circles">
              ...
              <p>
                ...
                reports, or full investment portfolio. Personal records remain
                private unless you deliberately share a supported item.
              </p>
              <p>
                Members can see information created for the Circle and
                information another member explicitly shares there. Depending on
                your role, they may also see your display name, invitation
                status, contributions, settlement activity, and actions recorded
                in Circle history. Organizers can manage the Circle but cannot
                edit another member&apos;s private financial records.
              </p>
              <p>
                Before sharing, check that a record does not contain information
                about someone who has not agreed to the disclosure. Removing
                yourself or unsharing an item may not remove information another
                member already lawfully received or shared history needed to
                preserve the Circle&apos;s records.
              </p>
            </section>
            ...
            <section className={styles.legalSection} id="transfers">
              ...
              <p>
                ...
                data-protection rules may differ across locations. Where
                required, we use contractual, organizational, and technical
                measures intended to protect information transferred across
                borders.
              </p>
            </section>
            ...
            <section className={styles.legalSection} id="retention">
              ...
              <p>
                ...
                legal and accounting duties, and resolve disputes. Retention
                depends on the type of information and why it is needed.
              </p>
              <ul>
                <li>
                  Uploaded source files stored for server-side processing are
                  temporary and marked for deletion after 72 hours. Cleanup
                  jobs, failed processing, or backup expiration may take
                  additional time. Some supported imports can be parsed locally
                  without uploading the raw file.
                </li>
                <li>
                  Extracted and confirmed financial data remains in your account
                  until you edit, delete, wipe, or close the account, or until
                  retention is no longer necessary.
                </li>
                <li>
                  Billing, security, support, and audit records may be retained
                  for legal, fraud-prevention, accounting, and
                  dispute-resolution needs.
                </li>
                <li>
                  Backups, security logs, and records already shared with other
                  users may take additional time to expire or may remain where
                  law or another user&apos;s legitimate record requires it.
                </li>
              </ul>
              <p>
                Wiping data removes Clover app data while keeping your sign-in
                account. Deleting your account removes the local Clover account
                and requests deletion of the associated Clerk identity. Manage
                and confirm subscription cancellation with the provider shown in
                your Plan settings before closing your account. Certain limited
                records may remain where required by law or for security and
                dispute handling.
              </p>
            </section>
            ...
            <section className={styles.legalSection} id="security">
              ...
              <p>
                ...
                managed authentication through Clerk, encrypted network
                connections, server-side authorization checks, restricted
                database access, role and ownership checks, activity logging,
                and review tools that keep original and normalized import data
                traceable.
              </p>
              <p>
                No service can guarantee absolute security. Keep your sign-in
                methods secure, use a strong unique password where applicable,
                and contact us immediately if you believe someone accessed your
            ...
            <section className={styles.legalSection} id="choices">
              ...
              <p>
                ...
                information, object to processing, correct inaccurate
                information, request erasure or blocking, obtain portable data,
                file a complaint, and seek damages where appropriate.
              </p>
              <p>
                ...
                request where permitted or required by law.
              </p>
            </section>
            ...
            <section className={styles.legalSection} id="cookies">
              ...
              <p>
                ...
                reliable product operation. When analytics is configured,
                PostHog helps us understand page views, feature use, errors, and
                product performance. Clover does not use this information for
                third-party behavioral advertising.
              </p>
              <p>
                You can control cookies through your browser, but blocking
                essential storage may prevent sign-in or cause parts of Clover
            ...
            <section className={styles.legalSection} id="children">
              ...
              <p>
                ...
                valid parent or guardian authorization. If you believe a child
            ...
            <section className={styles.legalSection} id="changes">
              ...
              <p>
                ...
                change the effective date. If a change materially affects how we
                use personal information, we will provide additional notice
                where required.
              </p>
            </section>
            ...
            <section className={styles.legalSection} id="contact">
              ...
              <p>
                ...
                describe your request and the email connected to your Clover
                account.
              </p>
              <p>
                You may also learn about your rights or file a complaint with
                the{" "}
                <a
