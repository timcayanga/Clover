...
const checks = [
  ...
  [accountsRoute.includes("repairDuplicatePdaxWalletAccounts"), "Legacy PDAX wallet shells collapse into one canonical wallet"],
  [accountsRoute.includes('["Wallet", "PDAX Wallet"]'), "PDAX wallet restoration recognizes both legacy and canonical labels"],
  [accountsRoute.includes("hasCorrectedGotradeIdentity"), "Corrected GoTrade accounts cannot be relabeled from stale GSave checkpoints"],
  ...
  [institutionPage.includes('<option value="buy">Buy</option>'), "Trading History uses the simple Buy action"],
  [institutionPage.includes('<option value="sell">Sell</option>'), "Trading History uses the simple Sell action"],
  [institutionPage.includes('<option value="dividend">Dividend</option>'), "Trading History supports dividend income"],
  [institutionPage.includes('<option value="reinvested_dividend">Reinvested dividend</option>'), "Trading History supports reinvested dividends"],
