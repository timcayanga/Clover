...
export const ANALYTICS_EVENT_NAMES: AnalyticsEventName[] = [
  ...
  "import_processing_completed", "import_processing_stalled", "import_parser_arbitrated", "import_receipt_cache_reused", "import_client_stage", "review_queue_opened", "review_queue_completed", "review_queue_abandoned",
