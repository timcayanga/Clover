...
const envSchema = z.object({
  ...
  PADDLE_PLUS_PRODUCT_ID: z.string().min(1).optional(),
  PADDLE_PLUS_MONTHLY_PRICE_ID: z.string().min(1).optional(),
  PADDLE_PLUS_ANNUAL_PRICE_ID: z.string().min(1).optional(),
  PADDLE_PRO_PRODUCT_ID: z.string().min(1).optional(),
