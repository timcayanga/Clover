...
export const PLAN_FEATURE_DETAILS: Record<PlanFeatureKey, PlanFeatureDetail> = {
  manualTracking: createDetail({
    ...
    summary: "Free keeps the core manual workflow open. Plus keeps the same manual tools and adds more room for heavier use.",
    freeLabel: "Free",
    proLabel: "Plus",
  ...
  receiptScanning: createDetail({
    ...
    proItems: ["Keep receipt scanning turned on", "Use it with the larger shared Clover-token allowance"],
  }),
  accounts: createDetail({
    key: "accounts",
    title: "Non-cash accounts",
    summary: "Free covers the essentials; Plus gives you more accounts so the whole picture stays connected.",
    freeLabel: "Free",
    proLabel: "Plus",
    freeItems: ["10 non-cash accounts", "Add bank, wallet, card, and investment accounts"],
  ...
  uploads: createDetail({
    ...
    proItems: ["1,000,000 Clover tokens monthly", "250,000-token rolling 24-hour safeguard"],
  }),
  rows: createDetail({
    key: "rows",
    title: "Files and transaction rows",
    summary: "Both plans can retain their imported history. AI-assisted work draws from the shared Clover-token allowance.",
    freeLabel: "Free",
    proLabel: "Plus",
    freeItems: ["Unlimited transaction rows", "Unlimited files within the shared token allowance"],
    proItems: ["Unlimited transaction rows", "Unlimited files within the larger shared token allowance"],
  }),
  investments: createDetail({
    key: "investments",
    title: "Investment tracking",
    summary: "Free covers a basic holdings view. Plus adds a fuller portfolio lens with market tracking and richer analysis.",
    freeLabel: "Free",
    proLabel: "Plus",
    freeItems: [
  ...
  goals: createDetail({
    ...
    summary: "Free gives you a simple goal lane and basic progress. Plus adds a fuller coaching layer, richer history, and more actions.",
    freeLabel: "Free",
    proLabel: "Plus",
    freeItems: [
...
const PLAN_FEATURE_LABEL_MAP: Record<string, PlanFeatureKey> = {
  ...
  "100000 clover tokens monthly": "uploads",
  "1000000 clover tokens monthly": "uploads",
