...
// Schema creation belongs to Prisma migrations. Running DDL from every new
// serverless instance caused lock contention and repeated catalog scans.
export const ensureImportEnrichmentJobTable = async () => undefined;
