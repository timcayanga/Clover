...
export const CONTEXT_CORPUS_VERSION = "2026.08.01.4";
...
const deduplicatedWorldEntries = [...WORLD_CONTEXT_ENTRIES, ...WORLD_CONTEXT_ENTRIES_2, ...WORLD_CONTEXT_ENTRIES_3, ...WORLD_CONTEXT_ENTRIES_4, ...WORLD_VERTICAL_CONTEXT_ENTRIES]
  .map((entry) => ({
    ...entry,
    aliases: entry.aliases.filter((alias) => {
      const normalizedAlias = normalizeCanonicalAlias(alias);
