...
export const CONTEXT_CORPUS_VERSION = "2026.07.13";
...
const baseEntries: ContextEntry[] = [
  ...
  { id: "th-wallets", aliases: ["truemoney thailand", "rabbit line pay", "line pay thailand", "shopeepay thailand", "airpay thailand"], signalKind: "payment_rail", countryCode: "TH", regionCode: "SEA", paymentRail: "thailand_wallet", currency: "THB", institutionType: "wallet", confidence: 86 },
  ...
  { id: "jp-wallets", aliases: ["paypay japan", "rakuten pay japan", "d payment japan", "d払い", "au pay japan", "nanaco", "waon"], signalKind: "payment_rail", countryCode: "JP", regionCode: "EAS", paymentRail: "japan_wallet", currency: "JPY", institutionType: "wallet", confidence: 88 },
  ...
  { id: "kr-wallets", aliases: ["kakao pay", "naver pay", "toss pay", "samsung pay korea", "payco korea", "ssg pay"], signalKind: "payment_rail", countryCode: "KR", regionCode: "EAS", paymentRail: "korea_wallet", currency: "KRW", institutionType: "wallet", confidence: 88 },
  { id: "kr-transit", aliases: ["t money", "tmoney", "cashbee", "korea subway", "korail", "kakao t", "seoul metro"], signalKind: "travel", countryCode: "KR", regionCode: "EAS", paymentRail: "korea_transit", currency: "KRW", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 88 },
  ...
  { id: "cn-wallets", aliases: ["alipay china", "wechat pay", "unionpay", "云闪付", "alipay mainland"], signalKind: "payment_rail", countryCode: "CN", regionCode: "EAS", paymentRail: "china_wallet", currency: "CNY", institutionType: "wallet", confidence: 88 },
