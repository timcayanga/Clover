...
import { WORLD_CONTEXT_ENTRIES_5, WORLD_REGIONAL_PROFILES_5 } from "@/lib/world-context-corpus-packs-5";
import { WORLD_VERTICAL_CONTEXT_ENTRIES } from "@/lib/world-context-corpus-verticals";
...
export const CONTEXT_CORPUS_VERSION = "2026.08.01.6";
...
const baseEntries: ContextEntry[] = [
  ...
  { id: "fr-urban-transit", aliases: ["service navigo", "navigo easy", "ile de france mobilites", "ratp ticket", "transilien sncf"], signalKind: "travel", countryCode: "FR", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 88 },
  ...
  { id: "de-public-transit", aliases: ["db bahn", "deutsche bahn ticket", "bvg ticket", "hvv hamburg", "vrr ticket", "mvg munich"], signalKind: "travel", countryCode: "DE", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 84 },
  { id: "es-public-transit", aliases: ["renfe", "metro de madrid", "tmb transport", "emt madrid", "fgc barcelona"], signalKind: "travel", countryCode: "ES", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 84 },
  { id: "it-public-transit", aliases: ["trenitalia ticket", "italo treno", "atac roma", "atm milano ticket", "trenord ticket"], signalKind: "travel", countryCode: "IT", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 84 },
  { id: "nl-public-transit", aliases: ["ov chipkaart", "ns international", "gvb vervoerbewijs", "ret rotterdam", "htm den haag"], signalKind: "travel", countryCode: "NL", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 82 },
  { id: "be-public-transit", aliases: ["sncb nmbs", "stib mivb", "de lijn", "tec belgium"], signalKind: "travel", countryCode: "BE", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 82 },
  { id: "at-public-transit", aliases: ["oebb ticket", "wiener linien ticket", "westbahn austria"], signalKind: "travel", countryCode: "AT", regionCode: "EUR", currency: "EUR", categoryHint: "Transport", counterpartyType: "transport_provider", purposeHint: "transport", travelLikely: true, confidence: 82 },
  ...
  { id: "kh-services-telecom", aliases: ["edc cambodia", "smart axiata cambodia", "cellcard cambodia", "aeon maxvalu cambodia", "metfone cambodia"], signalKind: "merchant", countryCode: "KH", regionCode: "SEA", currency: "KHR", categoryHint: "Bills & Utilities", counterpartyType: "utility_provider", purposeHint: "utilities", confidence: 66 },
  { id: "mm-services-commerce", aliases: ["yangon electricity supply", "mytel myanmar", "ooredoo myanmar", "city mart myanmar", "marketplace myanmar"], signalKind: "merchant", countryCode: "MM", regionCode: "SEA", currency: "MMK", categoryHint: "Bills & Utilities", counterpartyType: "utility_provider", purposeHint: "utilities", confidence: 62 },
  ...
  { id: "ae-commerce-expanded", aliases: ["nesto hypermarket uae", "union coop uae", "careem food uae", "noon food uae", "spinneys dubai"], signalKind: "merchant", countryCode: "AE", regionCode: "MEA", currency: "AED", categoryHint: "Shopping", counterpartyType: "merchant", purposeHint: "retail", confidence: 74 },
  { id: "sa-commerce-expanded-services", aliases: ["extra stores saudi", "tamimi markets saudi", "hungerstation saudi", "marsool saudi", "al baik saudi"], signalKind: "merchant", countryCode: "SA", regionCode: "MEA", currency: "SAR", categoryHint: "Shopping", counterpartyType: "merchant", purposeHint: "retail", confidence: 72 },
  { id: "qa-commerce-expanded", aliases: ["talabat qatar", "carrefour qatar", "monoprix qatar", "snoonu qatar", "family food centre qatar"], signalKind: "merchant", countryCode: "QA", regionCode: "MEA", currency: "QAR", categoryHint: "Shopping", counterpartyType: "merchant", purposeHint: "retail", confidence: 70 },
  { id: "kw-commerce-expanded", aliases: ["xcite kuwait", "sultan center kuwait", "talabat kuwait", "boots kuwait", "carrefour kuwait"], signalKind: "merchant", countryCode: "KW", regionCode: "MEA", currency: "KWD", categoryHint: "Shopping", counterpartyType: "merchant", purposeHint: "retail", confidence: 68 },
  { id: "us-healthcare-education", aliases: ["kaiser permanente", "unitedhealthcare", "nyu tuition", "ucla payment", "walgreens clinic"], signalKind: "merchant", countryCode: "US", regionCode: "NAM", currency: "USD", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 72 },
  { id: "ca-healthcare-education", aliases: ["sun life canada", "manulife canada", "university of toronto", "mcgill university", "shoppers drug mart pharmacy"], signalKind: "merchant", countryCode: "CA", regionCode: "NAM", currency: "CAD", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 70 },
  { id: "au-healthcare-education", aliases: ["medicare australia", "bupa australia", "university of melbourne", "unsw sydney", "tertiary health australia"], signalKind: "merchant", countryCode: "AU", regionCode: "OCE", currency: "AUD", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 70 },
  { id: "gb-healthcare-education", aliases: ["nhs england", "bupa uk", "university college london", "kings college london", "boots pharmacy uk"], signalKind: "merchant", countryCode: "GB", regionCode: "EUR", currency: "GBP", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 70 },
  { id: "ph-digital-investment", aliases: ["gotrade philippines", "gotrade ph", "maya invest philippines", "gcrypto philippines", "gcash crypto"], signalKind: "merchant", countryCode: "PH", regionCode: "SEA", currency: "PHP", categoryHint: "Investments", counterpartyType: "investment_platform", purposeHint: "investment", confidence: 78 },
  ...
  { id: "ca-investment-insurance", aliases: ["questrade canada", "wealthsimple trade", "canada life insurance", "desjardins insurance", "sun life wealth canada"], signalKind: "merchant", countryCode: "CA", regionCode: "NAM", currency: "CAD", categoryHint: "Investments", counterpartyType: "investment_platform", purposeHint: "investment", confidence: 70 },
  { id: "ca-subscriptions-housing", aliases: ["crave canada", "bell fibe internet", "rogers ignite canada", "rent payment canada", "condo fees canada"], signalKind: "merchant", countryCode: "CA", regionCode: "NAM", currency: "CAD", categoryHint: "Housing", counterpartyType: "merchant", purposeHint: "housing", confidence: 68 },
  { id: "au-investment-insurance", aliases: ["australia super", "hostplus", "commsec australia", "medibank australia", "nib australia"], signalKind: "merchant", countryCode: "AU", regionCode: "OCE", currency: "AUD", categoryHint: "Insurance", counterpartyType: "insurer", purposeHint: "insurance", confidence: 70 },
  { id: "au-subscriptions-housing", aliases: ["stan australia", "foxtel australia", "nbn australia", "rent payment australia", "strata fees australia"], signalKind: "merchant", countryCode: "AU", regionCode: "OCE", currency: "AUD", categoryHint: "Housing", counterpartyType: "merchant", purposeHint: "housing", confidence: 68 },
  { id: "gb-investment-insurance", aliases: ["hargreaves lansdown", "aj bell uk", "aviva insurance uk", "legal and general uk", "direct line insurance uk"], signalKind: "merchant", countryCode: "GB", regionCode: "EUR", currency: "GBP", categoryHint: "Investments", counterpartyType: "investment_platform", purposeHint: "investment", confidence: 70 },
  { id: "gb-subscriptions-housing", aliases: ["sky uk subscription", "now tv uk", "virgin media uk", "rent payment uk", "council tax uk"], signalKind: "merchant", countryCode: "GB", regionCode: "EUR", currency: "GBP", categoryHint: "Housing", counterpartyType: "government_service", purposeHint: "housing", confidence: 68 },
  { id: "ae-insurance-investment", aliases: ["metlife gulf uae", "oman insurance uae", "saxo bank uae", "sarwa uae", "property finder uae"], signalKind: "merchant", countryCode: "AE", regionCode: "MEA", currency: "AED", categoryHint: "Insurance", counterpartyType: "insurer", purposeHint: "insurance", confidence: 66 },
  { id: "sa-healthcare-education", aliases: ["king faisal specialist hospital", "dr sulaiman al habib", "king saud university fees", "noor hospital saudi", "mouwasat hospital saudi"], signalKind: "merchant", countryCode: "SA", regionCode: "MEA", currency: "SAR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 66 },
  { id: "qa-healthcare-education", aliases: ["hamad medical corporation", "sidra medicine qatar", "qatar university fees", "al ahli hospital qatar", "aster hospital qatar"], signalKind: "merchant", countryCode: "QA", regionCode: "MEA", currency: "QAR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 64 },
  { id: "kw-healthcare-education", aliases: ["sabah hospital kuwait", "al seef hospital kuwait", "kuwait university fees", "new mowasat hospital", "dar al hayat hospital kuwait"], signalKind: "merchant", countryCode: "KW", regionCode: "MEA", currency: "KWD", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 62 },
  { id: "id-healthcare-education", aliases: ["bpjs kesehatan", "halodoc indonesia", "siloam hospitals indonesia", "ruangguru indonesia", "universitas indonesia"], signalKind: "merchant", countryCode: "ID", regionCode: "SEA", currency: "IDR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 70 },
  { id: "id-utilities-commerce", aliases: ["pln electricity indonesia", "telkomsel indonesia", "indihome indonesia", "superindo indonesia", "blibli indonesia"], signalKind: "merchant", countryCode: "ID", regionCode: "SEA", currency: "IDR", categoryHint: "Bills & Utilities", counterpartyType: "utility_provider", purposeHint: "utilities", confidence: 72 },
  { id: "vn-healthcare-education", aliases: ["vinmec vietnam", "hanoi medical university", "vinschool vietnam", "pasteur institute vietnam", "pharmacity vietnam"], signalKind: "merchant", countryCode: "VN", regionCode: "SEA", currency: "VND", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 68 },
  { id: "vn-utilities-commerce", aliases: ["evn national vietnam", "viettel vietnam", "vnpt vietnam", "winmart vietnam", "coopmart vietnam"], signalKind: "merchant", countryCode: "VN", regionCode: "SEA", currency: "VND", categoryHint: "Bills & Utilities", counterpartyType: "utility_provider", purposeHint: "utilities", confidence: 70 },
  { id: "th-healthcare-education", aliases: ["bumrungrad hospital", "bangkok hospital", "chulalongkorn university fees", "thailand post health", "boots thailand pharmacy"], signalKind: "merchant", countryCode: "TH", regionCode: "SEA", currency: "THB", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 70 },
  { id: "th-utilities-commerce", aliases: ["pea electricity thailand", "mea bangkok", "ais thailand bill", "central department store thailand", "lazada thailand"], signalKind: "merchant", countryCode: "TH", regionCode: "SEA", currency: "THB", categoryHint: "Bills & Utilities", counterpartyType: "utility_provider", purposeHint: "utilities", confidence: 70 },
  { id: "de-healthcare-education", aliases: ["charite berlin", "techniker krankenkasse", "heidelberg university fees", "tuv sud germany", "docmorris germany"], signalKind: "merchant", countryCode: "DE", regionCode: "EUR", currency: "EUR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 68 },
  { id: "de-subscriptions-housing", aliases: ["ard beitrag", "zdf beitrag", "deutsche telekom internet", "mietzahlung deutschland", "immobilienscout24"], signalKind: "merchant", countryCode: "DE", regionCode: "EUR", currency: "EUR", categoryHint: "Housing", counterpartyType: "merchant", purposeHint: "housing", confidence: 66 },
  { id: "fr-healthcare-education", aliases: ["assurance maladie france", "ap hp paris", "sorbonne universite fees", "doctolib france", "pharmacie france"], signalKind: "merchant", countryCode: "FR", regionCode: "EUR", currency: "EUR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 66 },
  { id: "fr-subscriptions-housing", aliases: ["edf france bill", "orange internet france", "freebox france", "loyer france", "seloger france"], signalKind: "merchant", countryCode: "FR", regionCode: "EUR", currency: "EUR", categoryHint: "Housing", counterpartyType: "merchant", purposeHint: "housing", confidence: 64 },
  { id: "es-healthcare-education", aliases: ["sanitas espana", "quiron salud", "universidad complutense fees", "salud madrid", "farmacia espana"], signalKind: "merchant", countryCode: "ES", regionCode: "EUR", currency: "EUR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 66 },
  { id: "it-healthcare-education", aliases: ["san raffaele milano", "humanitas italy", "universita bocconi fees", "poste salute italy", "farmacia italiana"], signalKind: "merchant", countryCode: "IT", regionCode: "EUR", currency: "EUR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 64 },
  { id: "ch-healthcare-education", aliases: ["university hospital zurich", "hirslanden switzerland", "eth zurich fees", "epfl fees", "migros bank insurance"], signalKind: "merchant", countryCode: "CH", regionCode: "EUR", currency: "CHF", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 64 },
  { id: "ie-healthcare-education", aliases: ["vhi healthcare ireland", "mater hospital dublin", "trinity college dublin fees", "university college dublin fees", "boots ireland pharmacy"], signalKind: "merchant", countryCode: "IE", regionCode: "EUR", currency: "EUR", categoryHint: "Health & Wellness", counterpartyType: "healthcare_provider", purposeHint: "healthcare", confidence: 64 },
  { id: "ph-charity-government", aliases: ["red cross philippines", "world vision philippines", "abs cbn foundation", "donation philippines", "dole philippines"], signalKind: "fee", countryCode: "PH", regionCode: "SEA", currency: "PHP", categoryHint: "Financial", counterpartyType: "government", purposeHint: "charity", confidence: 72 },
  { id: "ph-subscriptions-household", aliases: ["spotify philippines", "netflix philippines", "sky cable philippines", "converge fiber philippines", "rent condo philippines"], signalKind: "merchant", countryCode: "PH", regionCode: "SEA", currency: "PHP", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 74 },
  { id: "ph-dining-delivery-expanded", aliases: ["grabfood ph merchant", "foodpanda ph merchant", "delivery rider philippines", "restaurant reservation philippines", "cloud kitchen philippines"], signalKind: "merchant", countryCode: "PH", regionCode: "SEA", currency: "PHP", categoryHint: "Dining", counterpartyType: "merchant", purposeHint: "food_delivery", confidence: 70 },
  { id: "sg-subscriptions-household", aliases: ["singtel broadband singapore", "starhub broadband singapore", "netflix singapore", "spotify singapore", "town council singapore"], signalKind: "merchant", countryCode: "SG", regionCode: "SEA", currency: "SGD", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 70 },
  { id: "my-subscriptions-household", aliases: ["astro malaysia", "unifi malaysia", "maxis fibre malaysia", "netflix malaysia", "spotify malaysia"], signalKind: "merchant", countryCode: "MY", regionCode: "SEA", currency: "MYR", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 68 },
  { id: "id-subscriptions-delivery", aliases: ["netflix indonesia", "spotify indonesia", "telkomsel orbit", "gofood indonesia", "shopeefood indonesia"], signalKind: "merchant", countryCode: "ID", regionCode: "SEA", currency: "IDR", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 68 },
  { id: "vn-subscriptions-delivery", aliases: ["netflix vietnam", "spotify vietnam", "fpt play vietnam", "shopeefood vietnam", "baemin vietnam"], signalKind: "merchant", countryCode: "VN", regionCode: "SEA", currency: "VND", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 66 },
  { id: "th-subscriptions-delivery", aliases: ["netflix thailand", "spotify thailand", "truevisions thailand", "line man thailand", "foodpanda thailand"], signalKind: "merchant", countryCode: "TH", regionCode: "SEA", currency: "THB", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 66 },
  { id: "br-subscriptions-household", aliases: ["netflix brasil", "spotify brasil", "globoplay", "vivo fibra brasil", "aluguel brasil"], signalKind: "merchant", countryCode: "BR", regionCode: "LATAM", currency: "BRL", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 66 },
  { id: "mx-subscriptions-household", aliases: ["netflix mexico", "spotify mexico", "izzi internet mexico", "telmex internet mexico", "renta mexico"], signalKind: "merchant", countryCode: "MX", regionCode: "LATAM", currency: "MXN", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 64 },
  { id: "za-subscriptions-household", aliases: ["netflix south africa", "spotify south africa", "showmax south africa", "rain internet south africa", "rent south africa"], signalKind: "merchant", countryCode: "ZA", regionCode: "AFR", currency: "ZAR", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 62 },
  { id: "ke-subscriptions-delivery", aliases: ["netflix kenya", "spotify kenya", "showmax kenya", "glovo kenya", "jiji kenya"], signalKind: "merchant", countryCode: "KE", regionCode: "AFR", currency: "KES", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 60 },
  { id: "ng-subscriptions-delivery", aliases: ["netflix nigeria", "spotify nigeria", "showmax nigeria", "bolt food nigeria", "jiji nigeria services"], signalKind: "merchant", countryCode: "NG", regionCode: "AFR", currency: "NGN", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 60 },
  { id: "lk-subscriptions-household", aliases: ["netflix sri lanka", "spotify sri lanka", "dialog tv sri lanka", "slt broadband sri lanka", "rent sri lanka"], signalKind: "merchant", countryCode: "LK", regionCode: "SAS", currency: "LKR", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 58 },
  { id: "ae-subscriptions-household", aliases: ["netflix uae", "spotify uae", "du home internet uae", "etisalat home uae", "shahid vip uae"], signalKind: "merchant", countryCode: "AE", regionCode: "MEA", currency: "AED", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 64 },
  { id: "sa-subscriptions-household", aliases: ["netflix saudi", "spotify saudi", "stc home internet saudi", "mobily home saudi", "shahid vip saudi"], signalKind: "merchant", countryCode: "SA", regionCode: "MEA", currency: "SAR", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 62 },
  { id: "qa-subscriptions-household", aliases: ["netflix qatar", "spotify qatar", "ooredoo home qatar", "vodafone home qatar", "tod qatar"], signalKind: "merchant", countryCode: "QA", regionCode: "MEA", currency: "QAR", categoryHint: "Subscriptions", counterpartyType: "merchant", purposeHint: "subscription", confidence: 60 },
...
const deduplicatedWorldEntries = [...WORLD_CONTEXT_ENTRIES, ...WORLD_CONTEXT_ENTRIES_2, ...WORLD_CONTEXT_ENTRIES_3, ...WORLD_CONTEXT_ENTRIES_4, ...WORLD_CONTEXT_ENTRIES_5, ...WORLD_VERTICAL_CONTEXT_ENTRIES, ...WORLD_COMMERCE_CONTEXT_ENTRIES, ...WORLD_TRAVEL_HEALTH_CONTEXT_ENTRIES]
  .map((entry) => ({
    ...entry,
    aliases: entry.aliases.filter((alias) => {
      const normalizedAlias = normalizeCanonicalAlias(alias);
