...
const BANK_BRANDS: Array<{ match: RegExp; brand: AccountBrand }> = [
  ...
  },
  {
    ...
    brand: makeBrand({
      label: "Maya",
      logoUrl: "https://logo.clearbit.com/maya.ph",
      accent: "#0B1F3A",
  ...
  },
  {
    ...
    brand: makeBrand({
      label: "GCash",
      logoUrl: "https://logo.clearbit.com/gcash.com",
      accent: "#118CF0",
  ...
  },
  {
    ...
    brand: makeBrand({
      ...
      logoUrl: "https://logo.clearbit.com/bankcom.com.ph",
      accent: "#0C7B72",
  ...
  },
  {
    ...
    brand: makeBrand({
      label: "HSBC",
      logoUrl: "https://logo.clearbit.com/hsbc.com.ph",
      accent: "#DB0011",
  ...
  },
  {
    ...
    brand: makeBrand({
      label: "GoTyme",
      logoUrl: "https://logo.clearbit.com/gotyme.com.ph",
      accent: "#6D28D9",
  ...
  },
  {
    ...
    brand: makeBrand({
      label: "MariBank",
      logoUrl: "https://logo.clearbit.com/maribank.sg",
      accent: "#0F766E",
