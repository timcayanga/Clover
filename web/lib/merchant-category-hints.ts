...
const SPECIFIC_MERCHANT_CATEGORY_HINTS: Array<{
  ...
  },
  {
    ...
    lower: /nomad\s+express|priority\s+pass|airport|terminal\s+1|terminal\s+2|south\s+wing/,
    compact: /nomadexpress|prioritypass|airport|terminal1|terminal2|southwing/,
  },
  {
