...
const SPECIFIC_MERCHANT_CATEGORY_HINTS: Array<{
  ...
  },
  {
    ...
    compact: /paypal|amazon|alibaba|lazada|shopee|uniqlo|zara|hm|watsons|puregold|landers|snr|dutyfree|robinsonseasymart|unclejohns|7eleven|robinsonssupermarket|themarketplace|smstore|powermac|beyondthebox|abenson|acehardware|truevalue|bench|penshoppe|miniso|muji|cottonon|savemore|shopwise|waltermart|lawson|smhypermarket|smsupermarket|rustans|toykingdom|octagon/,
  },
];
