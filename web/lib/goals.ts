...
const FINANCIAL_EXPERIENCE_PROFILES: Record<FinancialExperienceLevel, FinancialExperienceProfile> = {
  beginner: {
    ...
    emptyStateTitle: "Upload files to see Clover turn statements into a clear picture.",
    emptyStateCopy:
  ...
  comfortable: {
    ...
    emptyStateTitle: "Upload files to wake up the dashboard.",
    emptyStateCopy:
  ...
  advanced: {
    ...
    emptyStateTitle: "Upload files to load the numbers fast.",
    emptyStateCopy:
